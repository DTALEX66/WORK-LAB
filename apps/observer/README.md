...
- 只持久化在项目 `.project-local/runs/observer/` 下的 Observer-owned event log；
...
```text
python services/orchestration/sidecar.py --project-root . --runtime-root <project>/.project-local/runs/workflow
```
