...
- 包名：`@upstash/context7-mcp`（runtime resolver 选择版本；portable baseline 不锁定版本）
...
1. 有原生工具无法覆盖的明确增益；
2. candidate audit 中固定版本和许可证/来源检查；portable baseline 只声明官方 Context7 包名，由 runtime resolver 选择版本；
