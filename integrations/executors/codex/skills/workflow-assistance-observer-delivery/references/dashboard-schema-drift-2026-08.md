...
```sql
-- .project-local/runs/workflow/canonical.sqlite
...
- Existing services: check `.project-local/runs/*/sidecar-process.json` and
  `.project-local/runs/observer/dashboard-process.json` for PID/port BEFORE starting a new
