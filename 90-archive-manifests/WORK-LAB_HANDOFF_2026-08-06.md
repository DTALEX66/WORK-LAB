...
- 不要删除 `D:\All projects\WORK-LAB-ARCHIVE`；
- 不要删除 archive 内的 source/physical checkout、manifest 或恢复证据；
...
3. 需要恢复旧 checkout 时，使用：
   - `D:\All projects\WORK-LAB-ARCHIVE\migration-20260805T120000Z\source-checkouts\`
   - `D:\All projects\WORK-LAB-ARCHIVE\migration-20260805T120000Z\physical-checkouts\`
