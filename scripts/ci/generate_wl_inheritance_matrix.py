...
WL_TABLE = [
    ...
    ("WL-600", "Open Design 大师资料证据卡", "移交 Open Design，不在 WORK-LAB 执行", "SUPERSEDED_MOVED"),
    ("WL-610", "Open Design 失败案例回归集", "移交 Open Design，不在 WORK-LAB 执行", "SUPERSEDED_MOVED"),
    ("WL-620", "Open Design runtime/交付", "移交 Open Design，不在 WORK-LAB 执行", "SUPERSEDED_MOVED"),
    ("WL-630", "MINIGAME 设计能力", "移交/独立，不在 WORK-LAB 执行", "SUPERSEDED_MOVED"),
