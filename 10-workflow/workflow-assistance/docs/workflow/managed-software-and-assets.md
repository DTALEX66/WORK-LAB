...
| 无阻塞 | 13 skills 按需加载 | skills 总（14 个，8KB/个 <10KB 基线） · guidance 10.6KB · on-demand | 代理超时宽松（90s/600s） | — | — |
| 模型满血 | reasoning_effort=medium（官方默认，live 实测）· max_tokens 8192 | cc-switch-official → 官方 provider · cost_multiplier=1.0 · 无限额 | 官方路由无限速 | — | — |
